...
/**
 *
 * @see github.com/Insolita/unused-scanner/blob/master/scanner_config.example.php
 *
 *
...
//$projectPath = (string\TYPO3\CMS\Core\Core\Environment::getPublicPath() ?? '');
$projectPath = __DIR__ . '/../../../../';
...
$scanDirectories = [
    ...
    $projectPath . 'public' . DIRECTORY_SEPARATOR . 'typo3conf' . DIRECTORY_SEPARATOR . 'ext',
...
//$env = new \TYPO3\CMS\Core\Core\Environment();
//dump($env);
//dump($scanDirectories);
